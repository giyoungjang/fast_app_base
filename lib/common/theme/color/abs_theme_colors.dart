...
abstract class AbstractThemeColors {
  ...
  Color get roundedLayoutBackground => const Color.fromARGB(123, 24, 24, 24);

  get unreadColor => const Color.fromARGB(255, 48, 48, 48);

  Color? get lessImportant => AppColors.grey;

  Color? get blueText => null;

  Color get plus => const Color.fromARGB(255, 230, 71, 83);
  Color get minus => const Color.fromARGB(255, 48, 58, 241);
